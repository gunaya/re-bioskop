...
export default function Studio( props ) {
    ...
    const { studio } = props;
    return (
        <div className="container shadow-lg rounded-md overflow-hidden mb-10 w-2/5 md:w-1/6 mx-4 bg-secondary-default p-2 flex h-auto flex-wrap justify-center items-center">
